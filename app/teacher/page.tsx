...
export default function Teacher() {
    ...
    const [assagn, setAssagn] = useState<Teacherprops>({
        session: '',
        facult: '',
        study_year: '',
        name: '',
    ...
    useEffect(() => {
        const getData = async () => {
            ...
            const matiere = user?.role === 'prof' ? pro : pr
            setProgram(matiere)
        }
            } finally {
                setLoading(false);
        ...
        <div className="min-h-screen bg-linear-to-br from-gray-50 to-gray-100 p-4 md:p-8">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="bg-white rounded-2xl p-6 mb-6 shadow-sm border border-gray-100">
                    ...
                    <form action='/teacher' className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                        {/* Matière Filter */}
                        <div>
                            ...
                            >
                                ...
                                {program?.map((pro:any,i) => (
                                    <option key={i} value={pro.matiere}>{role !== 'prof' ? `${pro.courses}` : `${pro.matiere}`}</option>
                                ))}
                            </select>
                        </div>
